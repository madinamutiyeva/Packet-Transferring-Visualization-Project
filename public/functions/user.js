...
document.getElementById('receive-graph-btn').addEventListener('click', receiveGraph);
...
document.getElementById('sender-form').addEventListener('submit', function (event) {
